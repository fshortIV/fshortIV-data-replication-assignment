...
AnnualPlot <- AnnualPlot + geom_smooth(method = "lm", formula = y ~ x + I(x^2)) + xlab("Group Size") + ylab("Home Range Size") + theme_classic() + xlim(10, 110) + ylim(6, 24) + geom_text(x=60, y=23.5, label="Annual: y = 0.003x^2 - 0.346x + 22.539", size=3.5, color="gray28") 
AnnualPlot
...
MonthlyPlot <- MonthlyPlot + geom_smooth(method = "lm", formula = y ~ x + I(x^2)) + xlab("Group Size") + ylab("Monthly Home Range Size") + theme_classic() + xlim(10, 110) + ylim(6, 24) + geom_text(x=60, y=22.5, label="Monthly: y = 0.004x^2 - 0.417x + 20.019", size=3.5)
MonthlyPlot
...
BothPlot <- BothPlot + geom_text(x=60, y=22.5, label="Monthly: y = 0.004x^2 - 0.417x + 20.019", size=3.5, color="gray28") + geom_text(x=60, y=17, label="Annual", size=5) + geom_text(x=80, y=7, label="Monthly", size=5)
BothPlot
...
DailyTravelPlot <- DailyTravelPlot + geom_smooth(method = "lm", formula = y ~ x + I(x^2)) + xlab("Group Size") + ylab("Daily Travel Distance (km") + theme_classic() + xlim(10, 110) + ylim(4.4, 6.0) + geom_text(x=60, y=5.9, label="Monthly: y = 0.000475x^2 - 0.056x + 6.249", size=3.5,color="gray28")
DailyTravelPlot
...
EvennessPlot <- EvennessPlot + geom_smooth(method = "lm", formula = y ~ x + I(x^2)) + xlab("Group Size") + ylab("Evenness of space use") + theme_classic() + xlim(10, 110) + ylim(4.0, 5.0) + geom_text(x=60, y=4.9, label="Monthly: y = 0.0002x^2 - 0.020x + 4.710", size=3.5, color="gray28") 
EvennessPlot
...
FGCPlot <- FGCPlot + geom_smooth(method = "lm", formula = y ~ x + I(x^2)) + xlab("Group Size") + ylab("Fecal glucocorticoid (ng/g dry feces") + theme_classic() + xlim(10, 110) + ylim(70, 92) + geom_text(x=60, y=91, label="Monthly: y = 0.006x^2 - 0.785x + 97.314", size=3.5, color="gray28") + geom_text(x=60, y=17, label="Annual", size=5)
FGCPlot
