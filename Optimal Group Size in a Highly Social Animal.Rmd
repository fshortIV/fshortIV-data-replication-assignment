...
AnnualPlot <- AnnualPlot + geom_smooth(method = "lm", formula = y ~ x + I(x^2)) + xlab("Group Size") + ylab("Home Range Size") + theme_classic() + xlim(10, 110) + ylim(6, 24) + geom_text(x=60, y=23.5, label="Annual: y = 0.003x^2 - 0.346x + 22.539", size=3.5) 
AnnualPlot
...
BothPlot <- BothPlot + geom_text(x=60, y=22.5, label="Monthly: y = 0.004x^2 - 0.417x + 20.019", size=3.5)
BothPlot
